...
namespace InventoryManagementSystem
{
    public partial class LoginForm : Form
    {
        ...
        {
            if (MessageBox.Show("Keluar", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                Application.Exit();
            }
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Nama atau password tidak valid!", "Akses Ditolak", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                con.Close();
            }
            catch (Exception ex)
